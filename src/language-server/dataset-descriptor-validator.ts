...
import { datasetDescriptorAstType, Authoring, GeneralInfo, Author, Founder, Maintenance, DatasetDefinition } from './generated/ast';
...
export class DatasetDescriptorValidator {
    ...
    hintsOfMaintainer(type: Maintenance, accept: ValidationAcceptor): void {

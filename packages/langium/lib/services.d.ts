 ...
 */
export declare type LangiumGeneratedServices = {
    Grammar: Grammar;
 ...
 */
export declare type LangiumLspServices = {
    completion: {
 ...
 */
export declare type LangiumDefaultServices = {
    parser: {
 ...
 */
export declare type LangiumServices = LangiumGeneratedServices & LangiumDefaultServices;
/**
 ...
 */
export declare type LangiumGeneratedSharedServices = {
    AstReflection: AstReflection;
};
/**
 * Services shared between multiple languages where Langium provides default implementations.
 */
export declare type LangiumDefaultSharedServices = {
 ...
 */
export declare type LangiumSharedServices = LangiumDefaultSharedServices & LangiumGeneratedSharedServices;
/**
 ...
 */
export declare type DeepPartial<T> = T[keyof T] extends Function ? T : {
    [P in keyof T]?: DeepPartial<T[P]>;
};
/**
 * Language-specific services to be partially overridden via dependency injection.
 */
export declare type PartialLangiumServices = DeepPartial<LangiumServices>;
/**
 * Shared services to be partially overridden via dependency injection.
 */
export declare type PartialLangiumSharedServices = DeepPartial<LangiumSharedServices>;
